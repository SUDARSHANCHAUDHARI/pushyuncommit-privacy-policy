# PushyUncommit Privacy Policy

**Effective Date:** May 17, 2026
_Last updated: May 17, 2026_
**Version:** 1.1.0

PushyUncommit ("we," "our," or "us") is a developer tool. PushyUncommit is a developer tool that helps review git repository status and can connect to a local server you run on your own machine. This Privacy Policy explains what information the app collects, how it is used, and the choices you have. By installing or using PushyUncommit you agree to the practices described below.

## Information We Collect

### Location Data
- PushyUncommit does not collect location data.

### Account Information
- No PushyUncommit account is required.
- If you use GitHub integration, GitHub receives the API requests you make through the tool.

### Device Information
- Repository paths, git status summaries, local server URL, preferences, and optional GitHub query settings may be processed locally.

## How We Use Your Information

### Location Sharing
- PushyUncommit does not use your location.

### Account Management
- Show local git repository status and help you inspect uncommitted work.
- Connect to a local PushyUncommit server when you configure one.
- Query GitHub only when you use GitHub-related features.

### Service Improvement
- Improve developer workflow visibility.
- We do not operate a cloud service that stores your repository contents.

## Storage and Retention

### Data Storage
- Settings such as local server URL may be stored locally.
- Repository status is read from your local machine or local server instance.
- GitHub data is requested directly from GitHub when you use GitHub features.

### Data Retention
- Local settings remain until you clear them or uninstall the app/tool.
- Git repository data remains in your local repositories.
...
### Family Groups
- PushyUncommit does not use MyFamilyTracker-style family groups unless explicitly described in this policy.
...
### Third Parties
- GitHub receives API requests only when you use GitHub integration.
- No repository contents are sent to Sudarshan Tech Labs servers.
...
* **Network access/INTERNET**: Used to connect to your local PushyUncommit server or GitHub when configured.

### Optional Permissions

* GitHub integration and local server connection are configured by you.

## Your Rights and Controls

### Location Sharing Control
- No location sharing exists in PushyUncommit.

### Account Management
- No PushyUncommit account is required; GitHub account controls live in GitHub settings.

### Data Access
- You can clear local settings and disconnect from local/GitHub integrations at any time.
...
### Permissions
- You can revoke Android permissions in Android Settings -> Apps -> PushyUncommit -> Permissions.
...
* **GitHub Repository:** https://github.com/SUDARSHANCHAUDHARI/pushyuncommit-privacy-policy
* **Email:** sunny.sudarshan@gmail.com
* **Main App Repository:** https://github.com/SUDARSHANCHAUDHARI/PushyUncommit
...
- Subject: "Data Deletion Request - PushyUncommit"
...
1. Open PushyUncommit, if installed
...
- GitHub API when you enable GitHub features
- A local PushyUncommit server you run yourself
...
PushyUncommit is built with privacy in mind. The app is built with:
- React/TypeScript developer tooling
- Local git status inspection
- Optional GitHub integration
- Optional local server connection
...
- **Clarified local developer-tool data, local server use, and GitHub integration.**
